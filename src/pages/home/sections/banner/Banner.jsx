        ...
        <div className="wrapper rounded-lg bg-[#9dc02055]">
            <div className="flex lg:flex-row flex-col justify-center items-center gap-3">
                <div className="md:py-10 p-4 md:px-8 lg:p-12">
                    <h1 className="font-bold text-[32px] md:text-[55px] leading-10 md:leading-[68px] font-fontOswald">Share the Abundance, Feed the Soul</h1>
                    ...
                    <Button className="bg-[#9CC020]">Join Now</Button>
                </div>
                <div>
