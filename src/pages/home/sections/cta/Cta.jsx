...
const Cta = () => {
    return (
        <div className="wrapper">
            <div className="rounded-md py-5 md:py-14 text-center px-5 md:px-[30px] text-white" style={{backgroundImage: 'url(https://i.postimg.cc/MGS78TTt/Untitled-design-1.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}}>
